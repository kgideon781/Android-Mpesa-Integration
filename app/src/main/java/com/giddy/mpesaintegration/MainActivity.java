package com.giddy.mpesaintegration;
...
import com.giddy.mpesa_.interfaces.AuthListener;
import com.giddy.mpesa_.interfaces.MpesaListener;
import com.giddy.mpesa_.models.STKPush;
...
public class MainActivity extends AppCompatActivity implements AuthListener, MpesaListener {
    ...
    public static final String CONSUMER_KEY = "B7jBHDzZonbmHTstaGglF5o7tUCS9KRP";
    public static final String CONSUMER_SECRET = "DcL1WGRJpjSCIeow";
    public static final String CALLBACK_URL = "http://boiling-stream-31182.herokuapp.com/";
