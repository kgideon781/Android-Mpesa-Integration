...
import com.giddy.mpesa_.network.NetworkHandler;
import com.giddy.mpesa_.utils.Config;
import com.giddy.mpesa_.utils.Pair;
import com.giddy.mpesa_.utils.Preferences;
...
public class Mpesa {
    ...
    public void pay(Context context, STKPush push){
        ...
        try {
            ...
            if (mode == com.giddy.mpesa_.Mode.PRODUCTION)
